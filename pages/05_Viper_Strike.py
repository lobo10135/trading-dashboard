...
with col_center:
    ...
    def get_market_data(ticker, name, rb_threshold_pct, stop_offset_pct, stop_diff, tp_offset, hold_weeks):
        ...
        range_w0 = abs(w0_data['High'] - w0_data['Low']) # Geändert auf w0
        
        # Real Body %: (Real Body aktuell / Range aktuelle Woche) * 100
        percent_change = ((rb_w0 / range_w0) * 100) if range_w0 != 0 else 0.0
        ...
        return {
            ...
            "Real Body Vorwoche": format_de(rb_w0),
